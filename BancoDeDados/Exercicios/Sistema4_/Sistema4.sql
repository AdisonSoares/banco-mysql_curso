...
--QUESTÃO:
--Traga todos os funcionarios que trabalhem
...
--OBSERVAÇÕES:
--Existem 21 funcionários no departamento de filmes
--Existem 53 funcionários no departamento de roupas
...
--EXPLICAÇÃO:
--Como está sendo usado o OR nesse caso tendo a segunda consulta lógica opcional
--colocamos na primeira condição quem tem mais chances de uma saída verdadeira,
--pois a segunda condição não precisará ser consultada para validar.

---------------------------------------------------------------------------------------------------------------

--QUESTÃO:
--Contar o total de funcionarios do sexo masculino e feminino
...
--OBSERVAÇÕES:
--Existem 491 funcionários do sexo feminino
--Existem 484 funcionários do sexo masculino

---------------------------------------------------------------------------------------------------------------

--QUESTÃO:
--O gestor de marketing pediu a lista de funcionarias que trabalhem no departamento
...
--OBSERVAÇÕES:
--Existem 32 funcionárias no departamento do lar
--Existem 09 funcionárias no departamento de filmes
...
--colocamos na primeira condição quem tem mais chances de uma saída verdadeira,
--pois a segunda condição não precisará ser consultada para validar.
--Como a condição para a consulta é ter os dois departamentos do sexo feminino
--foi necessario o uso do conectivo lógico AND, para somar as duas possibilidades.
...
--OBSERVAÇÕES:
--Existem 47 funcionários do setor Jardim
...
--EXPLICAÇÃO:
--Como está sendo usado OR nesse caso tendo a segunda consulta lógica opcional
--colocamos na primeira condição quem tem mais chances de uma saída verdadeira,
--pois a segunda condição não precisará ser consultada para validar.
